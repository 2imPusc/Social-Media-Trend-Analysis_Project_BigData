...
def get_video_captions(video_id, languages=None):
    if languages is None:
        languages = ["en"]  # Mặc định chỉ lấy tiếng Anh
    captions_data = []
    try:
        ...
        for item in response["items"]:
            ...
            # Chỉ lấy phụ đề thuộc danh sách ngôn ngữ được chỉ định
...
def crawl_youtube_trending(region_code="US", max_videos=50, max_comments_per_video=100, max_workers=2, caption_languages="en"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max-videos", type=int, default=100, help="Số lượng video tối đa")
